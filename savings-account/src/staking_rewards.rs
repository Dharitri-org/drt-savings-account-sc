...
mod delegation_proxy {
    ...
    pub trait Delegation {
        ...
        fn claim_rewards(&self, #[payment_multi] payments: ManagedVec<DctTokenPayment<Self::Api>>);
    }
}
    ...
    + crate::common_storage::CommonStorageModule
{
    ...
    fn claim_staking_rewards(&self) {
        ...
        let _ = self.run_while_it_has_gas(
            || {
                ...
                transfers.push(DctTokenPayment {
    ...
    fn claim_staking_rewards_callback(
        ...
        #[call_result] result: ManagedAsyncCallResult<
            MultiValue2<BigUint, ManagedVec<DctTokenPayment<Self::Api>>>,
        >,
    ...
    // TODO: Convert MOAX to WrapedMoax first (DEX does not convert MOAX directly)
    ...
    fn convert_staking_token_to_stablecoin(&self) {
        ...
        let received_payment: DctTokenPayment<Self::Api> = self
