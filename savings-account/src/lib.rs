    ...
    + common_storage::CommonStorageModule
{
    ...
    fn init(
        ...
        require!(
            stablecoin_token_id.is_valid_dct_identifier(),
        ...
        require!(
            staked_token_id.is_moax() || staked_token_id.is_valid_dct_identifier(),
    ...
    fn repay(&self) -> RepayResultType<Self::Api> {
        ...
        let first_payment: DctTokenPayment<Self::Api> = payments.get(0);
        let second_payment: DctTokenPayment<Self::Api> = payments.get(1);
        ...
        let extra_stablecoins_payment = if extra_stablecoins_paid > 0u32 {
            ...
            DctTokenPayment::new(stablecoin_token_id, 0, BigUint::zero())
        };
        ...
        let liquid_staking_payment = DctTokenPayment::new(
            liquid_staking_token_id,
            liquid_staking_nonce,
