...
use dharitri_wasm::types::{Address, DctLocalRole, ManagedBuffer, ManagedVec, TokenIdentifier};
...
pub static STAKED_TOKEN_TICKER: &[u8] = b"MOAX";
...
pub static NFT_ROLES: &[DctLocalRole] = &[
    ...
    SavingsAccountObjBuilder: 'static + Copy + Fn() -> savings_account::ContractObj<DebugApi>,
{
    pub fn new(sa_builder: SavingsAccountObjBuilder) -> Self {
        ...
        b_mock.set_dct_local_roles(sa_wrapper.address_ref(), LEND_TOKEN_ID, NFT_ROLES);
        b_mock.set_dct_local_roles(sa_wrapper.address_ref(), BORROW_TOKEN_ID, NFT_ROLES);
    ...
    fn init_delegation_mock(
        ...
        b_mock.set_moax_balance(staker, &(&stake_denominated * NR_STAKING_POSITIONS));
