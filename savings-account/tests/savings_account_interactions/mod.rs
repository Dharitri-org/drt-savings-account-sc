...
use dharitri_wasm::{dharitri_codec::multi_types::OptionalValue, types::Address};
    ...
    SavingsAccountObjBuilder: 'static + Copy + Fn() -> savings_account::ContractObj<DebugApi>,
{
        ...
        self.b_mock.execute_dct_transfer(
            ...
            |sc| {
                ...
                assert_eq!(
                    ...
                    dharitri_wasm::types::BigUint::from_bytes_be(&liq_staking_amount.to_bytes_be())
                );
    ...
    pub fn call_repay(
        ...
        self.b_mock
            .execute_dct_multi_transfer(borrower, &self.sa_wrapper, &transfers, |sc| {
                ...
                assert_eq!(
                    ...
                    dharitri_wasm::types::BigUint::from_bytes_be(&borrow_token_amount.to_bytes_be())
                );
    ...
    SavingsAccountObjBuilder: 'static + Copy + Fn() -> savings_account::ContractObj<DebugApi>,
{
    ...
    pub fn default_borrows(&mut self) {
        ...
        self.b_mock
            .check_dct_balance(&borrower, STABLECOIN_TOKEN_ID, &rust_biguint!(4 * 18_750));
    }
