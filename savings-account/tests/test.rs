...
fn calculate_rewards_test() {
    ...
    sa_setup.b_mock.check_dct_balance(
    ...
    for i in 1..4u64 {
        sa_setup.b_mock.check_nft_balance(
            ...
            Some(&dharitri_wasm::dharitri_codec::Empty),
        );
    }
...
fn repay_full_first_pos_test() {
    ...
    sa_setup
        .b_mock
        .check_dct_balance(&borrower, STABLECOIN_TOKEN_ID, &rust_biguint!(75_000));
    ...
    sa_setup
        .b_mock
        .check_dct_balance(&borrower, STABLECOIN_TOKEN_ID, &rust_biguint!(35_834));
...
fn repay_partial_test() {
    ...
    sa_setup.b_mock.check_nft_balance(
        ...
        Option::<&dharitri_wasm::dharitri_codec::Empty>::None,
    );
    sa_setup
        .b_mock
        .check_dct_balance(&borrower, STABLECOIN_TOKEN_ID, &rust_biguint!(51_501));
